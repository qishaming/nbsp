    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formIding">
                    <input type="hidden" name="smallType.smallTypeId" >
                    小类id：<input  name="smallType.smallTypeid" id="smallTypeid2" class="easyui-textbox">
                    小类名称：<input  name="smallType.smallTypeName" id="smallTypeName2" class="easyui-textbox">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="updateSmallType()">
                    提交更改
                </button>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formIdings">
                    ...
                    小类名称：<input  name="smallType.smallTypeName" id="smallTypeName" class="easyui-textbox">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="addSmallTypeSub()">
                    提交
                </button>
            </div>
        </div>
...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="index." title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">小类管理</a> </div>
    </div>
            ...
            <div class="span12">
                <div class="widget-box">
                    <div class="widget-title">
                        ...
                        <button  class='btn btn-primary'  data-toggle='modal' data-target='#addDiv' onclick='addSmallType("+value+")'>增加</button>
                    </div>
...
<script type="text/javascript">
    ...
    $("#tablelist").bootstrapTable({
        url:"<%=request.getContextPath()%>/small/querySmallType.action",
        striped: true,//隔行变色
        ...
        uniqueId: "SmallTypeId",                     //每一行的唯一标识，一般为主键列
        ...
        columns:[{
            ...
            },
            {
                ...
                width:100,formatter: function(value,row,index){
                 ...
                 //'<button type="button" class="btn btn-primary"  data-toggle="modal" data-target="#updateDiv" onclick="updateSmallType('+row.smallTypeId+')">修改</button>'+
                return   '<button type="button" class="btn btn-danger"  onclick="deleteSmallType('+row.smallTypeId+')" >删除</button>';
...
<script type="text/javascript">
    ...
    //修改
    function updateSmallType(smallTypeName){

        $.ajax({
            url:"<%=request.getContextPath()%>/small/updateSmallType.action",
            type:"post",
            data:{"smallType.smallTypeName":smallTypeName},
            dataType:"json",
            success:function (data){
                $("[name='smallType.smallTypeName']").val(data.smallTypeName);
            }
        });

    }

    function addSmallTypeSub() {
        var smallTypeName = $("#smallTypeName").val();
        var bigTypeId = $("#bigTypeId2").val();

        $.ajax({
            url:"<%=request.getContextPath()%>/small/addSmallType.action",
            type:"post",
            data:{"smallType.smallTypeName":smallTypeName,
    ...
    function deleteSmallType(smallTypeId) {

        $.ajax({
            url: "<%=request.getContextPath()%>/small/deleteSmallType.action",
            dataType: "text",
            type: "post",
            data: {"smallType.smallTypeId": smallTypeId},
            success: function (data) {
                alert("删除成功！");
            }
        })
